...
using Microsoft.AspNetCore.Authorization; // تأكد من إضافة هذا الـ using

namespace API.Controllers
{
    [Authorize] // تأكد إن الـ Controller كله محمي بـ Authorization
    ...
    public class MessageController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetInbox()
        {
            ...
            Console.WriteLine("mooooooooooomen : "+inboxItems);
